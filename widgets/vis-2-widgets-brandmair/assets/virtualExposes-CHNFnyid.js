...
let __tla = (async () => {
  ...
  _ = {
    "./TrvzbThermostat": async () => {
      ...
      const t = await o(() => import("./TrvzbThermostat-BwwniiCw.js").then(async (m) => {
        await m.__tla;
        return m;
      }), [], import.meta.url), e = {};
    ...
    "./HeizstabWidget": async () => {
      ...
      const t = await o(() => import("./HeizstabWidget-DQ8xaN6r.js").then(async (m) => {
        await m.__tla;
        return m;
      }), [], import.meta.url), e = {};
      return Object.assign(e, t), Object.defineProperty(e, "__esModule", {
    ...
    "./PvSpeicherWidget": async () => {
      ...
      const t = await o(() => import("./PvSpeicherWidget-DD1YC1_v.js").then(async (m) => {
        await m.__tla;
        return m;
      }), [], import.meta.url), e = {};
      return Object.assign(e, t), Object.defineProperty(e, "__esModule", {
    ...
    "./WarmwasserWidget": async () => {
      ...
      const t = await o(() => import("./WarmwasserWidget-ZBwia_3q.js").then(async (m) => {
        await m.__tla;
        return m;
      }), [], import.meta.url), e = {};
      return Object.assign(e, t), Object.defineProperty(e, "__esModule", {
    ...
    "./translations": async () => {
      ...
      const t = await o(() => import("./translations-L1jhguig.js"), [], import.meta.url), e = {};
      return Object.assign(e, t), Object.defineProperty(e, "__esModule", {
        value: true,
        enumerable: false
      }), e;
