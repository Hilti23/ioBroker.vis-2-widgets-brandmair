...
let __tla = (async () => {
  ...
  c = {
    "./TrvzbThermostat": async () => {
      ...
      const t = await r(() => import("./TrvzbThermostat-DtR2mfmh.js").then(async (m) => {
        await m.__tla;
        return m;
      }), [], import.meta.url), e = {};
    ...
    "./HeizstabWidget": async () => {
      ...
      const t = await r(() => import("./HeizstabWidget-DnUtARdp.js").then(async (m) => {
        await m.__tla;
        return m;
      }), [], import.meta.url), e = {};
      return Object.assign(e, t), Object.defineProperty(e, "__esModule", {
    ...
    "./PvSpeicherWidget": async () => {
      ...
      const t = await r(() => import("./PvSpeicherWidget-D3TE7y7B.js").then(async (m) => {
        await m.__tla;
        return m;
      }), [], import.meta.url), e = {};
      return Object.assign(e, t), Object.defineProperty(e, "__esModule", {
    ...
    "./MuelltonnenWidget": async () => {
      ...
      const t = await r(() => import("./MuelltonnenWidget-ClNxpcal.js").then(async (m) => {
        await m.__tla;
        return m;
      }), [], import.meta.url), e = {};
      return Object.assign(e, t), Object.defineProperty(e, "__esModule", {
    ...
    "./EnergiemanagerWidget": async () => {
      ...
      const t = await r(() => import("./EnergiemanagerWidget-9H7okJHg.js").then(async (m) => {
        await m.__tla;
        return m;
      }), [], import.meta.url), e = {};
      return Object.assign(e, t), Object.defineProperty(e, "__esModule", {
    ...
    "./UrlaubWidget": async () => {
      ...
      const t = await r(() => import("./UrlaubWidget-grpGMvLz.js").then(async (m) => {
        await m.__tla;
        return m;
      }), [], import.meta.url), e = {};
      return Object.assign(e, t), Object.defineProperty(e, "__esModule", {
    ...
    "./translations": async () => {
      ...
      const t = await r(() => import("./translations-CjdqyELj.js"), [], import.meta.url), e = {};
      return Object.assign(e, t), Object.defineProperty(e, "__esModule", {
        value: true,
        enumerable: false
      }), e;
