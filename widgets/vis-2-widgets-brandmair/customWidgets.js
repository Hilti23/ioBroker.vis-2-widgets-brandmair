...
let __tla = (async () => {
  ...
  const an = "federation-manifest.json", ln = ".json", cn = "FEDERATION_DEBUG", B = {
    ...
    NPM: "npm",
    APP: "app"
  }, pn = "__MF_DEVTOOLS_MODULE_INFO__", _n = "ENCODE_NAME_PREFIX", gn = ".federation", En = {
  ...
  function Tn() {
    return typeof process < "u" && Se && Se.FEDERATION_DEBUG ? !!Se.FEDERATION_DEBUG : typeof FEDERATION_DEBUG < "u" && FEDERATION_DEBUG ? true : In();
  }
  const Nn = function() {
  ...
  var D = {};
  const y = N, ft = z, pr = "[ Federation Runtime ]", Mn = (e, t, r = y.SEPARATOR) => {
    ...
    if (!e) return "";
    let r = e;
    return r === "." && (r = "default_export"), r.startsWith("./") && (r = r.replace("./", "")), It(r, "__federation_expose_", t);
  }, On = (e, t) => e ? It(e, "__federation_shared_", t) : "", $n = (e, t) => {
  ...
  function Hn(e, t = {}) {
    ...
    let c = {};
    Object.keys(r).length || (c = ((_a2 = e.remotes) == null ? void 0 : _a2.reduce((_, M) => {
      let k;
      const A = M.federationContainerName;
      return a.includes(A) ? k = n[A] : "version" in M ? k = M.version : k = M.entry, _[A] = {
        matchedVersion: k
      }, _;
    }, {})) || {}), Object.keys(r).forEach((_) => c[_] = {
      matchedVersion: a.includes(_) ? n[_] : r[_]
    });
    const { remoteEntry: { path: l, name: u, type: f }, types: d = {
      ...
      zip: "",
      api: ""
    }, buildInfo: { buildVersion: h }, globalName: m, ssrRemoteEntry: p } = e.metaData, { exposes: E } = e;
    let g = {
      version: o || "",
      buildVersion: h,
      globalName: m,
    ...
    if ((_c = e.metaData) == null ? void 0 : _c.prefetchEntry) {
      const { path: _, name: M, type: k } = e.metaData.prefetchEntry;
      g = {
        ...g,
        prefetchEntry: Z(_, M),
        prefetchEntryType: k
    ...
    if ("publicPath" in e.metaData ? (s = {
      ...
      const _ = Z(p.path, p.name);
      s.ssrRemoteEntry = _, s.ssrRemoteEntryType = p.type || "commonjs-module";
    }
    return s;
  }
  function Cn(e) {
  ...
  var ue = {};
  const $t = z, Er = "[ Module Federation ]", pe = console, Un = [
    "logger.ts",
    "logger.js",
    "captureStackTrace",
    "Logger.emit",
...
`)}` : void 0;
  ...
  Ir.normalizeOptions = zn;
  var Tr = {};
  const Jn = (e) => e;
  Tr.createModuleFederationConfig = Jn;
  (function(e) {
    Object.defineProperty(e, Symbol.toStringTag, {
      value: "Module"
    });
    const t = N, r = ar, n = lr, o = cr, s = ur, i = fr, a = dr, c = z, l = D, u = ce, f = ue, d = fe, h = Nt, m = Ir, p = Tr;
...
`);
  ...
  R.arrayOptions = mo;
  R.getFMId = io;
  R.getRemoteEntryInfoFromSnapshot = po;
  R.isObject = uo;
  R.isPlainObject = fo;
  ...
  const pt = v.__GLOBAL_LOADING_REMOTE_ENTRY__;
  function vr(e) {
  ...
  vr(H);
  function yo() {
    v.__FEDERATION__.__GLOBAL_PLUGIN__ = [], v.__FEDERATION__.__INSTANCES__ = [], v.__FEDERATION__.moduleInfo = {}, v.__FEDERATION__.__SHARE__ = {}, v.__FEDERATION__.__MANIFEST_LOADING__ = {}, Object.keys(pt).forEach((e) => {
      delete pt[e];
    });
  }
  function So(e) {
  ...
  function Ro(e, t = (0, go.isDebugMode)()) {
    t && (v.__FEDERATION__.__DEBUG_CONSTRUCTOR__ = e, v.__FEDERATION__.__DEBUG_CONSTRUCTOR_VERSION__ = "2.3.0");
  }
  function _t(e, t) {
    if (typeof t == "string") {
      if (e[t]) return {
  ...
  const Io = () => H.__FEDERATION__.moduleInfo, Ar = (e, t) => {
    const r = _t(t, mt.getFMId(e)).value;
    if (r && !r.version && "version" in e && e.version && (r.version = e.version), r) return r;
    if ("version" in e && e.version) {
      const { version: n, ...o } = e, s = mt.getFMId(o), i = _t(H.__FEDERATION__.moduleInfo, s).value;
      if ((i == null ? void 0 : i.version) === n) return i;
    }
  }, To = (e) => Ar(e, H.__FEDERATION__.moduleInfo), No = (e, t) => {
  ...
  S.getGlobalSnapshot = Io;
  S.getGlobalSnapshotInfoByModuleInfo = To;
  S.getInfoWithoutType = _t;
  S.getPreloaded = Oo;
  ...
  Lr.compare = is;
  const ie = re, j = V, as = Lr;
  function ls(e) {
    return ie.pipe(j.parseCarets, j.parseTildes, j.parseXRanges, j.parseStar)(e);
  }
  function cs(e) {
    return ie.pipe(j.parseHyphen, j.parseComparatorTrim, j.parseTildeTrim, j.parseCaretTrim)(e.trim()).split(/\s+/).join(" ");
  }
  function us(e, t) {
    if (!e) return false;
    ...
    for (const u of l) {
      ...
      try {
        ...
        const m = h.split(/\s+/).map((E) => j.parseGTE0(E)).filter(Boolean);
        ...
        for (const E of m) {
          ...
          if (!as.compare({
            operator: _,
            version: ie.combineVersion(M, k, A, I),
            major: M,
            minor: k,
            patch: A,
  ...
  ne.DEFAULT_SCOPE = fs;
  const Ge = T, Dr = R, Hr = S, hs = ne, Ee = Pt;
  let gt = L;
  function ms(e, t, r, n) {
    var _a2, _b;
    let o;
  ...
  }, We = (e) => !!e.loaded || typeof e.lib == "function", _s = (e) => !!e.loading, gs = (e, t) => {
    if (!e || !t) return false;
    ...
    for (const l of c) if (o && e[l] && e[l][t]) {
      const { requiredVersion: u } = o, { version: f, useTreesShaking: d } = Ss(i)(e, l, t, a), h = () => {
        ...
        if (o.singleton) {
          ...
          const E = Re(a);
          if (E) {
            for (const [g, _] of Object.entries(e[l][t])) if (Re(_.treeShaking, a == null ? void 0 : a.usedExports) && Ee.satisfy(g, u)) return {
              shared: _,
              useTreesShaking: E
            };
          }
          for (const [g, _] of Object.entries(e[l][t])) if (Ee.satisfy(g, u)) return {
            shared: _,
  ...
  C.addUseIn = Ts;
  C.directShare = Ns;
  C.formatShareConfigs = ps;
  C.getGlobalShareScope = Rs;
  C.getRegisteredShare = bs;
  C.getTargetSharedOptions = Is;
  ...
  function xs(e, t, r) {
    ...
    return o || Ve.error(Te.RUNTIME_001, Te.runtimeDescMap, {
      remoteName: e,
      remoteEntryUrl: r,
      remoteEntryKey: n
    }), o;
  }
  async function Xs({ name: e, globalName: t, entry: r, loaderHook: n, getEntryUrl: o }) {
    const { entryExports: s } = ae.getRemoteEntryExports(e, t);
    if (s) return s;
    const i = o ? o(r) : r;
    return (0, Gr.loadScript)(i, {
      attrs: {},
      ...
      Ve.error(Te.RUNTIME_008, Te.runtimeDescMap, {
        remoteName: e,
        resourceUrl: i
      }, c);
    });
  ...
  async function Br(e) {
    ...
    if (!ae.globalLoading[i]) {
      ...
      ae.globalLoading[i] = a.emit({
        ...
        if (l instanceof Error && l.message.includes(Te.RUNTIME_008) && !f && !s) {
          const d = (m) => Br({
            ...m,
  ...
  J.preloadAssets = si;
  const O = S, Ct = C, ii = de, ai = X, li = J, ci = {
 ...
 ${(0, mi.safeToString)(this.remoteInfo)}`), this.remoteEntryExports = e, this.remoteEntryExports;
    ...
    async init(e, t, r) {
      ...
      this.initing = true, this.initPromise = (async () => {
        const { remoteEntryInitOptions: o, shareScope: s, initScope: i } = pi(this.remoteInfo, this.host.shareScopeMap, r), a = await this.host.hooks.lifecycle.beforeInitContainer.emit({
          shareScope: s,
  ...
  var Ae = {};
  const Qe = T, Ri = R, Ii = he, Ti = me;
  var Ni = class extends Ii.SyncHook {
    constructor(e) {
  ...
  function wi(e, t, r, n, o) {
    ...
    if (Qr(n, r, (m, p, E) => {
      ...
      if (E) g = f;
        ...
        const I = d.find((w) => w.nameOrAlias === p.name || w.nameOrAlias === p.alias);
        if (!I) return;
        g = Bt.defaultPreloadArgs(I);
      } else if (d === true) g = f;
      else return;
      const _ = (0, Be.getResourceUrl)(m, Ne.getRemoteEntryInfoFromSnapshot(m).url);
      _ && a.push({
        name: p.name,
        moduleInfo: {
          name: p.name,
      ...
      k.length && "modules" in m && (M = (_a2 = m == null ? void 0 : m.modules) == null ? void 0 : _a2.reduce((I, w) => ((k == null ? void 0 : k.indexOf(w.moduleName)) !== -1 && I.push(w), I), []));
      function A(I) {
        const w = I.map((W) => (0, Be.getResourceUrl)(m, W));
        return g.filter ? w.filter(g.filter) : w;
      }
      if (M) {
        const I = M.length;
        for (let w = 0; w < I; w++) {
          const W = M[w], Ke = `${p.name}/${W.moduleName}`;
          e.remoteHandler.hooks.lifecycle.handlePreloadModule.emit({
            id: W.moduleName === "." ? p.name : Ke,
            name: p.name,
            remoteSnapshot: m,
            preloadConfig: g,
            remote: p,
      ...
      const m = (p, E) => {
        const { shared: g } = $i.getRegisteredShare(e.shareScopeMap, E.sharedName, p, e.sharedHandler.hooks.lifecycle.resolveShare) || {};
        g && typeof g.lib == "function" && (E.assets.js.sync.forEach((_) => {
          c.add(_);
      ...
      o.shared.forEach((p) => {
        var _a2;
        const E = (_a2 = u.shared) == null ? void 0 : _a2[p.sharedName];
        if (!E) return;
        const g = p.version ? E.find((_) => _.version === p.version) : E;
        g && Ne.arrayOptions(g).forEach((_) => {
          m(_, p);
        });
      });
    }
  ...
  var Xe = {};
  const tt = T, Di = R, U = S, Vt = Pe, Hi = ve, rt = Ae, Ci = Oe;
  let nt = L, Fe = K;
  function en(e, t) {
  ...
  var qi = class {
    constructor(e) {
      this.loadingHostSnapshot = null, this.manifestCache = /* @__PURE__ */ new Map(), this.hooks = new Ci.PluginSystem({
        beforeLoadRemoteSnapshot: new Hi.AsyncHook("beforeLoadRemoteSnapshot"),
  ...
  Xe.SnapshotHandler = qi;
  Xe.getGlobalRemoteInfo = en;
  var tn = {};
  const ot = T, Ui = ne, P = C, jt = Pe, Gi = ve, st = me, xt = Ae, Wi = Oe;
  let _e = K;
  var Bi = class {
    constructor(e) {
    ...
    initializeSharing(e = Ui.DEFAULT_SCOPE, t) {
      ...
      const l = a[e], u = (d, h) => {
        ...
        l[d] = l[d] || {};
        const E = l[d], g = E[m] && P.directShare(E[m]), _ = !!(g && ("eager" in g && g.eager || "shareConfig" in g && ((_a2 = g.shareConfig) == null ? void 0 : _a2.eager)));
        (!g || g.strategy !== "loaded-first" && !g.loaded && (!p != !_ ? p : c > E[m].from)) && (E[m] = h);
      }, f = async (d) => {
    ...
    loadShareSync(e, t) {
      ...
      if (n.get) {
        const i = n.get();
        return i instanceof Promise && ot.error((t == null ? void 0 : t.from) === "build" ? _e.RUNTIME_005 : _e.RUNTIME_006, _e.runtimeDescMap, {
      ...
      ot.error(_e.RUNTIME_006, _e.runtimeDescMap, {
        hostName: r.options.name,
        sharedPkgName: e
  ...
  tn.SharedHandler = Bi;
  var rn = {};
  const we = T, q = S, Xt = ne, Vi = C, ji = de, it = X, xi = Pe, Kt = J, Xi = je, Ki = he, se = ve, Yt = me, Yi = Ae, zi = Oe, Ji = Xe;
  let at = L, zt = K;
  var Zi = class {
    constructor(e) {
      this.hooks = new zi.PluginSystem({
        beforeRegisterRemote: new Yt.SyncWaterfallHook("beforeRegisterRemote"),
        registerRemote: new Yt.SyncWaterfallHook("registerRemote"),
        beforeRequest: new Yi.AsyncWaterfallHook("beforeRequest"),
        onLoad: new se.AsyncHook("onLoad"),
        handlePreloadModule: new Ki.SyncHook("handlePreloadModule"),
    ...
    async getRemoteModuleAndOptions(e) {
      ...
      const { id: o } = n, s = ji.matchRemoteWithNameAndExpose(t.options.remotes, o);
      ...
      return f || (f = new Xi.Module(d), t.moduleCache.set(l.name, f)), {
        module: f,
        moduleOptions: d,
        remoteMatchInfo: c
      };
      ...
      try {
        ...
        if (o) {
          ...
          if (l !== -1) {
            ...
            c = f.options.id || c;
            const d = Vi.getGlobalShareScope();
            let h = true;
            const m = [];
            Object.keys(d).forEach((p) => {
              ...
              E && Object.keys(E).forEach((g) => {
                const _ = E[g];
                _ && Object.keys(_).forEach((M) => {
                  const k = _[M];
                  k && Object.keys(k).forEach((A) => {
                    const I = k[A];
                    I && typeof I == "object" && I.from === s.name && (I.loaded || I.loading ? (I.useIn = I.useIn.filter((w) => w !== s.name), I.useIn.length ? h = false : m.push([
                      p,
                      g,
                      M,
                      A
            ...
            }), h && (f.shareScopeMap = {}, delete d[c]), m.forEach(([p, E, g, _]) => {
              var _a3, _b, _c;
              (_c = (_b = (_a3 = d[p]) == null ? void 0 : _a3[E]) == null ? void 0 : _b[g]) == null ? true : delete _c[_];
            }), q.CurrentGlobal.__FEDERATION__.__INSTANCES__.splice(l, 1);
          }
          const { hostGlobalSnapshot: u } = Ji.getGlobalRemoteInfo(e, t);
          if (u) {
  ...
  rn.RemoteHandler = Zi;
  const Qi = T, ea = ne, ta = C, ra = Vr, na = jr, oa = X, sa = je, Y = he, lt = ve, ia = me, Jt = Ae, ct = Oe, aa = xe, la = Zr, ca = Xe, ua = tn, fa = rn;
  let da = L, ut = K;
  const ha = typeof FEDERATION_OPTIMIZE_NO_SNAPSHOT_PLUGIN == "boolean" ? !FEDERATION_OPTIMIZE_NO_SNAPSHOT_PLUGIN : true;
  var ma = class {
    constructor(e) {
      this.hooks = new ct.PluginSystem({
        beforeInit: new ia.SyncWaterfallHook("beforeInit"),
        init: new Y.SyncHook(),
        beforeInitContainer: new Jt.AsyncWaterfallHook("beforeInitContainer"),
        initContainer: new Jt.AsyncWaterfallHook("initContainer")
      }), this.version = "2.3.0", this.moduleCache = /* @__PURE__ */ new Map(), this.loaderHook = new ct.PluginSystem({
      ...
      const t = ha ? [
        aa.snapshotPlugin(),
        la.generatePreloadAssetsPlugin()
      ] : [], r = {
        id: ra.getBuilderId(),
        name: e.name,
        plugins: t,
        remotes: [],
        shared: {},
        inBrowser: da.isBrowserEnvValue
      };
      this.name = e.name, this.options = r, this.snapshotHandler = new ca.SnapshotHandler(this), this.sharedHandler = new ua.SharedHandler(this), this.remoteHandler = new fa.RemoteHandler(this), this.shareScopeMap = this.sharedHandler.shareScopeMap, this.registerPlugins([
        ...r.plugins,
        ...e.plugins || []
      ]), this.options = this.formatOptions(r, e);
    }
    initOptions(e) {
      e.name && e.name !== this.options.name && Qi.error((0, ut.getShortErrorMsg)(ut.RUNTIME_010, ut.runtimeDescMap)), this.registerPlugins(e.plugins);
    ...
    formatOptions(e, t) {
      const { allShareInfos: r } = ta.formatShareConfigs(e, t), { userOptions: n, options: o } = this.hooks.lifecycle.beforeInit.emit({
        origin: this,
        userOptions: t,
        options: e,
        shareInfo: r
    ...
    registerPlugins(e) {
      const t = na.registerPlugins(e, this);
  ...
  (function(e) {
    ...
    const t = T, r = R, n = S, o = Pt, s = C, i = de, a = X, c = xr, l = je, u = Kr, f = nn;
    let d = L;
    const h = c.default;
  ...
  function Ea(e, t) {
    const r = ga();
    return _a.CurrentGlobal.__FEDERATION__.__INSTANCES__.find((n) => !!(r && n.options.id === r || n.options.name === e && !n.options.version && !t || n.options.name === e && t && n.options.version === t));
  }
  ir.getGlobalFederationInstance = Ea;
  (function(e) {
    Object.defineProperty(e, Symbol.toStringTag, {
      value: "Module"
    });
    ...
    let r = Rt, n = K;
    function o(p) {
      const E = new ((0, r.getGlobalFederationConstructor)() || r.ModuleFederation)(p);
      return (0, r.setGlobalFederationInstance)(E), E;
    }
    let s = null;
    function i(p) {
      const E = t.getGlobalFederationInstance(p.name, p.version);
      return E ? (E.initOptions(p), s || (s = E), E) : (s = o(p), s);
    }
    function a(...p) {
      return (0, r.assert)(s, n.RUNTIME_009, n.runtimeDescMap), s.loadRemote.apply(s, p);
    }
    function c(...p) {
      return (0, r.assert)(s, n.RUNTIME_009, n.runtimeDescMap), s.loadShare.apply(s, p);
    }
    function l(...p) {
      return (0, r.assert)(s, n.RUNTIME_009, n.runtimeDescMap), s.loadShareSync.apply(s, p);
    }
    function u(...p) {
      return (0, r.assert)(s, n.RUNTIME_009, n.runtimeDescMap), s.preloadRemote.apply(s, p);
    }
    function f(...p) {
      return (0, r.assert)(s, n.RUNTIME_009, n.runtimeDescMap), s.registerRemotes.apply(s, p);
    }
    function d(...p) {
      return (0, r.assert)(s, n.RUNTIME_009, n.runtimeDescMap), s.registerPlugins.apply(s, p);
    }
    function h() {
      return s;
    }
    function m(...p) {
      return (0, r.assert)(s, n.RUNTIME_009, n.runtimeDescMap), s.registerShared.apply(s, p);
    }
  ...
  const sn = "__mf_init____mf__virtual/vis2brandmairWidgets__mf_v__runtimeInit__mf_v__.js__";
  ...
  let rr, nr;
  async function Sa() {
    return rr ?? (rr = or(() => import("./assets/localSharedImportMap-Bi8d-eKe.js").then(async (m) => {
      await m.__tla;
      return m;
    }), [], import.meta.url)), rr;
  }
  async function ba() {
    return nr ?? (nr = or(() => import("./assets/virtualExposes-rE_ATBMw.js").then(async (m) => {
      await m.__tla;
      return m;
    }), [], import.meta.url).then((e) => e.default ?? e)), nr;
  }
  Ia = async function(e = {}, t = []) {
    const { usedShared: r, usedRemotes: n } = await Sa(), o = sr.init({
      name: tr,
      remotes: n,
      shared: r,
      plugins: [],
    ...
    if (s || (s = Qt[er] = {
      ...
      t.push(s), o.initShareScopeMap("default", e), ya(o);
      try {
